...
## Prerequisite
You'll need to download the following libraries and keep all the *.framework folders together in one place.\
`sdl3, sdl3_ttf, sdl3_mixer, sdl3_image`

## Test & Run
I use Visual Studio code as my IDE. Make sure you change the path (sdl frameworks path and your project path) in the CMakeLists.txt before you compile.
